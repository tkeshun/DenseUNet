...
list_path="./list.txt"
limit=50
python3 test.py --input_size 128 --savedir $SAVEFILE --data_path  $DATA_PATH --model_path $MODEL_PATH --sr 16000 --n_fft 1024 --win_l 1024 --hop_l 256 --list_path $list_path --tag $tag --limit $limit --model_type $MODEL_TYPE
